...
describe("apiClient interceptors", () => {
  ...
  it("adds a short server request reference to unexpected errors", async () => {
    const { default: apiClient } = await import("../apiClient.js");
    ...
    await expect(
      apiClient.interceptors.response.handlers[0].rejected({
        ...
        response: {
          status: 500,
          headers: { "x-request-id": "7e4de5f1-1234-4567-8901-abcdefabcdef" },
          data: {
