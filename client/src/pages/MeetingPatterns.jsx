      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex gap-4 border-b border-gray-200 dark:border-gray-700 mb-6">
          <button
            ...
            className={`pb-2 px-1 ${activeTab === "active" ? "border-b-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 font-medium" : "text-gray-500 dark:text-gray-400"}`}
          >
            Active Patterns
          </button>
          <button
            onClick={() => setActiveTab("acknowledged")}
            className={`pb-2 px-1 ${activeTab === "acknowledged" ? "border-b-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 font-medium" : "text-gray-500 dark:text-gray-400"}`}
          >
            Acknowledged
          </button>
        </div>
                  ...
                  {pattern.status === "active" && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="p-2 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-gray-700 rounded-md transition-colors"
                        title="Acknowledge"
                      >
                      ...
                      <button
                        ...
                        className="p-2 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-gray-700 rounded-md transition-colors"
                        title="Dismiss"
                      >
                        <X className="w-5 h-5" />
                      </button>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {pattern.affectedMeetings.map((m) => (
                          <Link
                            key={m._id}
                            to={`/meeting/${m._id}`}
                            className="text-xs px-3 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-full transition-colors"
                          >
                            {m.title}
                          </Link>
                        ))}
